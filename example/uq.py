...
if __name__ == "__main__":
    ...
    record_addr = os.path.join(DEFAULT_LOG_DIR, "uq_var_sel.csv")
    ...
    # adjust model config for UQ
    model_config = {'n_node': 50, 'n_layer': 1,
                    'hidden_weight_sd': .1, 'output_weight_sd': .1}
